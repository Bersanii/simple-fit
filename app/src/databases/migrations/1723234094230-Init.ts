...
export class Init1723234094230 implements MigrationInterface {
    name = 'Init1723234094230'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "especificacaoExercicio" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "nome" text NOT NULL, "grupamento" text NOT NULL)`);
